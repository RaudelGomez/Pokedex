...
function openImgHTML(pokemonData, color) {
    ...
    <div class="arrow-container" onclick="stopPropagation(event)">
      <svg id="arrow-right" xmlns="http://www.w3.org/2000/svg"fill="currentColor" class="bi bi-arrow-right-circle-fill arrow-slide" viewBox="0 0 16 16"  onclick="stopPropagation(event); nextPokemon(${pokemonData.id})">
